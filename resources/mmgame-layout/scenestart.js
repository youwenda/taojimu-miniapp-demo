...
(function (PIXI, lib) {
    ...
    lib.followradio = MovieClip.extend(function () {
        ...
        var instance2 = new Graphics()
            .drawCommands(shapes.scenestart[0]);
    ...
    lib.scenestart = MovieClip.extend(function () {
        MovieClip.call(this, {
            duration: 1,
            framerate: 60
        });
    ...
    lib.scenestart.assets = {
        ...
        "scenestart": "scene1images/scenestart.shapes.txt"
    };
})(PIXI, scenestartLib = scenestartLib || {});
var scenestartLib;
if (typeof module !== 'undefined' && module.exports) {
    module.exports = {
        stage: scenestartLib.scenestart,
        background: 0xffffff,
        width: 750,
        height: 1334,
        framerate: 60,
        totalFrames: 1,
        library: scenestartLib
    };
}